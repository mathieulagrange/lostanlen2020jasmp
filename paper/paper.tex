...
This is in contrast with fully end-to-end learning architectures, whose post hoc interpretability requires advanced techniques for saliency map estimation. %cite 
