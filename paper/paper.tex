...
In this evaluation framework, our system reaches a P@5 of $96.2\% \pm 2$.
Interestingly, querying the system with samples from the training set leads to a P@5 of $96.5\% \pm 2$, i.e., roughly on par with the test set.
