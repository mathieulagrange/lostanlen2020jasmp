...
\begin{abstract}
Instrumental playing techniques such as vibratos, glissandos, and trills often denote musical expressivity, both in erudite and folk contexts.
However, most existing approaches to music similarity retrieval fail to describe timbre beyond the so-called ``ordinary'' technique; use instrument identity as a proxy for timbre quality; and do not allow for rapid customization to the perceptual idiosyncracies of a newcoming subject.
In this article, we ask 31 human subjects to organize 78 isolated notes into an unconstrained number of timbre clusters.
...
Our model relies on joint time--frequency scattering features to extract spectrotemporal modulations at multiple scales and rates.
...
Over a dataset of 9346 isolated notes, we report a state-of-the-art precision at rank five (P@5) of $99.0\%\pm 1$.
...
% Le numerique permet d'approcher la question de la notation de facon implicite
% Cela ne retire pas l'interet de l'etude des graphemes ou du texte (glissando vs slide)

The prospect of modeling timbre perception thus necessarily exceeds the symbolic domain. \ml{even if research about its notation is of interest}
...
Rather than merely discriminating instruments as mutually exclusive categories, this function must reflect a consensus of quantitative judgments of acoustic dissimilarity, all other parameters---duration, pitch, and intensity---being equal \cite{thoret2018jasa}.
...
In such context, the composer queries the software with an arbitrary audio signal; the outcome of this query is an instrumental audio sample, alongside textual attributes of playing technique.
...
It recombines scattering coefficients so as to fit a training set of human judgments \cite{mcadams1995psychres}, which may either stem from the perceptual idiosyncracies of a single subject or from an intersubjective consensus.
...
Notwithstanding the growing accuracy of these architectures in the large data regime, it remains unclear how to extend them from musical instrument recognition to playing technique recognition, where labeled samples are considerably scarcer \cite{loureiro2004ismir}.
...
Yet, collecting subjective responses to acoustic stimuli is a tedious and unscalable procedure, therefore restricting the size of the musical corpus under study.
Such restriction hampers the applicability of iterative algorithms for representation learning, such as stochastic gradient descent in deep neural networks.
...
Once both experts completed their annotation, we averaged their scores
we retained all IMTs whose \ml{relevance score averaged over experts} was judged equal to 3 or higher.
...
Within two months, $K=31$ subjects accessed Cyberlioz and completed the task.%Figure \ref{fig:xp2display}. 
...
\ml{c'est bien ecrit, mais peut etre un peu trop detaillé, a voir avec Joakim}
...
In doing so, it is in line with a recent publication \cite{wang2020icassp}, in which the authors successfully trained a supervised classifier on joint time--frequency scattering features in order to detect and classify playing techniques from the Chinese bamboo flute (\emph{dizi}). \ml{limiter les self citations a une occurence}
...
\ml{I do not understand the coplexity argument here, not using anything is better, right ? Start with nothing then show lda, explain by reduced dimensionality of the lda output}
...
Previous publications have successfully applied separable time--frequency scattering in order to classify environmental sounds \cite{bauge2013icassp} as well as playing techniques involving periodic modulations \cite{wang2019ismir}.
...
%\ml{a deplacer ou a enlever : That being said, a potential future application of our work would be to use the pre-trained metric learning system $\mathbf{\Phi}$ to approximate out-of-sample targets \cite{carpentier2012cmj}.
...
\begin{figure}
\includegraphics[width=0.23\textwidth]{figures/violin_scattering/Vn-ord-C4-mf-4c_scalogram.pdf}
\includegraphics[width=0.23\textwidth]{figures/violin_scattering/Vn-tasto-C4-mf-4c_scalogram.pdf}
\includegraphics[width=0.23\textwidth]{figures/violin_scattering/Vn-trem-C4-mf-4c_scalogram.pdf}
\includegraphics[width=0.23\textwidth]{figures/violin_scattering/Vn-stacc-C4-mf_scalogram.pdf}

\includegraphics[width=0.23\textwidth]{figures/violin_scattering/Vn-ord-C4-mf-4c_scattering-compressed.pdf}
\includegraphics[width=0.23\textwidth]{figures/violin_scattering/Vn-tasto-C4-mf-4c_scattering-compressed.pdf}
\includegraphics[width=0.23\textwidth]{figures/violin_scattering/Vn-trem-C4-mf-4c_scattering-compressed.pdf}
\includegraphics[width=0.23\textwidth]{figures/violin_scattering/Vn-stacc-C4-mf_scattering-compressed.pdf}
\caption{\csentence{Violin scattering}}
\label{fig:violin-scattering}
\end{figure}


\begin{figure}
\includegraphics[width=0.23\textwidth]{figures/flute_scattering/Fl-ord-C4-mf_scalogram.pdf}
\includegraphics[width=0.23\textwidth]{figures/flute_scattering/Fl-sfz-C4-fp_scalogram.pdf}
\includegraphics[width=0.23\textwidth]{figures/flute_scattering/Fl-trill-maj2-C4-mf_scalogram.pdf}
\includegraphics[width=0.23\textwidth]{figures/flute_scattering/Fl-key-cl-C4-f_scalogram.pdf}

\includegraphics[width=0.23\textwidth]{figures/flute_scattering/Fl-ord-C4-mf_scattering_compressed.pdf}
\includegraphics[width=0.23\textwidth]{figures/flute_scattering/Fl-sfz-C4-fp_scattering_compressed.pdf}
\includegraphics[width=0.23\textwidth]{figures/flute_scattering/Fl-trill-maj2-C4-mf_scattering_compressed.pdf}
\includegraphics[width=0.23\textwidth]{figures/flute_scattering/Fl-key-cl-C4-f_scattering_compressed.pdf}
\caption{\csentence{Flute scattering}}
...
\begin{figure}
\includegraphics[width=0.3\textwidth]{figures/violin_scattering/Vn-ord-C4-mf-4c_scalogram.pdf}
\includegraphics[width=0.3\textwidth]{figures/violin_scattering/Vn-tasto-C4-mf-4c_scalogram.pdf}
\includegraphics[width=0.3\textwidth]{figures/violin_scattering/Vn-trem-C4-mf-4c_scalogram.pdf}

\hspace{0.05\textwidth}
\includegraphics[width=0.25\textwidth]{figures/violin_scattering/Vn-ord-C4-mf-4c_scattering-compressed.pdf}
\hspace{0.05\textwidth}
\includegraphics[width=0.25\textwidth]{figures/violin_scattering/Vn-tasto-C4-mf-4c_scattering-compressed.pdf}
\hspace{0.05\textwidth}
\includegraphics[width=0.25\textwidth]{figures/violin_scattering/Vn-trem-C4-mf-4c_scattering-compressed.pdf}

\csentence{(a)}\hspace{0.28\textwidth}
\csentence{(b)}\hspace{0.28\textwidth}
\csentence{(c)}
\vspace{1cm}

\includegraphics[width=0.3\textwidth]{figures/violin_scattering/Vn-stacc-C4-mf_scalogram.pdf}
\includegraphics[width=0.3\textwidth]{figures/violin_scattering/Vn-nonvib-C4-mf-4c_scalogram.pdf}
\includegraphics[width=0.3\textwidth]{figures/violin_scattering/Vn-sfz-C4-fp-4c_scalogram.pdf}

\hspace{0.05\textwidth}
\includegraphics[width=0.25\textwidth]{figures/violin_scattering/Vn-stacc-C4-mf_scattering-compressed.pdf}
\hspace{0.05\textwidth}
\includegraphics[width=0.25\textwidth]{figures/violin_scattering/Vn-nonvib-C4-mf-4c_scattering-compressed.pdf}
\hspace{0.05\textwidth}
\includegraphics[width=0.25\textwidth]{figures/violin_scattering/Vn-sfz-C4-fp-4c_scattering-compressed.pdf}

\csentence{(d)}\hspace{0.28\textwidth}
\csentence{(e)}\hspace{0.28\textwidth}
\csentence{(f)}


\caption{\csentence{Six playing techniques of the violin.}
Subfigures:
(a) ordinario, (b) sul tasto, (c) tremolo, (d) staccato, (e) nonvibrato, and (f) sforzando.
...
Note that the ordinary technique (a) contains vibrato.}
\label{fig:violin-scattering}
\end{figure}
