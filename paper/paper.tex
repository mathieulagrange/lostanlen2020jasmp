...
On the one hand, most publications in music information retrieval cast timbre modeling as an audio classification problem  \cite{martin1998asa,brown1999jasa,eronen2000icassp,herrera2003jnmr,wieczorkowska2003jiis,kaminskyj2005jiis,benetos2006icassp,lostanlen2016ismir}.
...
For instance, the Open-MIC dataset \cite{humphrey2016ismir}, maintained by the Community for Open and Sustainable Music Information Research (COSMIR) \cite{mcfee2016ismir}, comprises a vast corpus of X polyphonic music recordings spanning X instruments, as a derivative of the Free Music Archive (FMA) dataset.
