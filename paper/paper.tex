...
Recently, the authors of a previous publication trained a classifier of playing techniques on separable (\ie{} non-joint) time--frequency scattering features, and achieved state-of-the-art results in continuous performance recordings of the Chinese bamboo flute \cite{wang2019ismir}.
