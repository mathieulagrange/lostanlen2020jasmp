...
The \nameref{sec:soa} section reviews recent research in the computational modeling of musical timbre.
The \nameref{sec:survey} section describes our data collection procedure for auditory similarities across playing techniques.
The \nameref{sec:method} section presents the technical components of our machine listening system, namely joint time--frequency scattering and large-margin nearest neighbors.
The \nameref{sec:results} section conducts an ablation study of our system.
The \nameref{sec:discussion} section summarizes the implications of our findings for future research on timbral similarity.\footnote{Reproducible research statement: the implementation of the proposed model and the experimental protocol of this paper are available online, alongside anonymized data from human subjects:  \url{https://github.com/mathieulagrange/paperPlayingTechniquesSimilarityLearning}} %TODO: simplify this URL to lostanlen2020jasmp
...
In addition, previous publications in time--frequency scattering, whether separable or joint, lacks a human-centric evaluation, independently from any classification task.
...
In the case of IMTs, this number would amount to about 3k horizontal sliders or sets of radio buttons.
This number is
% in 30 to 60 minutes.
