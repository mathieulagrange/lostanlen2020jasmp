...
%TODO VL remove double citations to wang
...
%TODO VL: eviter la repetition combinatorial explosion
%
...
% TODO VL explain that the "other" instruments must be in the corpus!

% TODO VL explain that we average across two experts
