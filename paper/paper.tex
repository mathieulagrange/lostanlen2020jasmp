...
%We're no longer talking to biologists, so we don't need to be afraid.}% i think we will put equations later, in the methods section, while making sure to re-use the notations lambda, alpha, beta. OK?
