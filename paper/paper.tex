...
Although a graphemic study of playing techniques in music has research potential in music information retrieval \cite{calvo2020acm}, the prospect of modeling timbre perception necessarily exceeds the symbolic domain.
...
On the contrary, joint time--frequency scattering offers a faster extraction of spectrotemporal modulations while preserving properties of differentiability \cite{andreux2020jmlr} and invertibility \cite{lostanlen2019dafx}.
...
In the scientific literature on spectrotemporal receptive fields (STRF), the matrix $\mathbf{V}\boldsymbol{x}$ is called ``cortical output collapsed on the rate-scale axes'' \cite{elhilali2002speechcomm}.

Previous publications on STRF have focused on the visualization of synthetic stimuli and speech. % refs?
%Although one publication has turned to the visualization of isolated musical notes, the scope of discussion on the effect of technique is 

Figures \ref{fig:violin-scattering} and \ref{fig:flute-scattering}.
...
\begin{figure}[h!]
\includegraphics[width=0.9\textwidth]{figures/lostanlen2020jasmp_fig1_v4.pdf}
...
\begin{figure}
\center
\includegraphics[width = 0.85\textwidth]{figures/consensusVsI.png}
\caption{
...
\begin{figure}
\center
\includegraphics[width = 0.85\textwidth]{figures/consensusVsPt.png}
\caption{
...
\begin{figure}[h!]
\includegraphics[width=0.9\textwidth]{figures/ablationStudy}
