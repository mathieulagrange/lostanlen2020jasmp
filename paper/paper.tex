...
The metric learning stage is a linear map, optimized via large-margin nearest neighbors (LMNN) \cite{}.
It recombines scattering coefficients so as to fit a training set of human judgments.
