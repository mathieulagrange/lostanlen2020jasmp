...
Each of these instruments affords a panel of playing techniques ranging in size between X and Y. % TODO update with numbers
Furthermore, independently of the playing technique, some instruments may be temporarily equipped with timbre-altering mutes, such as a rubber sordina on the bridge of a violin or an aluminium ``wah-wah'' inside in the bell of a trumpet.
