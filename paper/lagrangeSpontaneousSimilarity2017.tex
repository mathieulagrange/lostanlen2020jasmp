...
\ml{ok, je regarde si on a toujours les données}
...
@data @figure}}
\ml{ok, tu peux utiliser le site de demo et faire une capture d'écran de l'utilisateur qui te va. Pour les autres display, je ne suis pas sur que cela soit utile.}
...
\ml{ok, je refais un code sur cette partie. Le dendrogram n'est pas un clustering, il part de la matrice de similarité. Bon apres, c'est tres lié...}
