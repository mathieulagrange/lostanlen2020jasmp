...
In X 2016, we recruited volunteers to use Cyberlioz on their own computer, via a web browser, and equipped with a pair of earphones. % TODO give the exact two months.
...
Within two months, 31 subjects (X men, Y women) accessed the Cyberlioz website and completed the task. % TODO break down by gender
