...
Indeed, while LMNN operates in the original dimensionality of joint time--frequency scattering features ($d=1180$), LDA projects these features onto a subspace whose dimensionality is equal to $(C+1)$, where $C$ is the number of clusters in the cluster graph $\mathcal{G}$.
% TODO complete this paragraph. 1180/20 ^2 = 59^2 = 3481
