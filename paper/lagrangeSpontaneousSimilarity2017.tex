...
\caption{Cluster analysis of the similarity judgments. $j/I$ and $j/Pt$ compare the partition obtained using the similarity judgments clustered using a growing number of clusters versus respectively the instrument partition and the playing technique partition. Normalizing null partitions based NMI $null$ is used to obtain normalized measures: $nj/I$ and $nj/Pt$. \ml{change legend, and use only one null}}
\label{fig:clusters}
\end{figure}
...
\center
\includegraphics[width = \textwidth]{figures/groupInstruments.png}
\caption{Computational model composed of two successive processing stages.}
\label{fig:model}
\end{figure}
